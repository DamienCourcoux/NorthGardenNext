...
export default function AddClientAdmin() {
    ...
    return (
        <LayoutAdmin>
            <Head>
                <title>North Garden | Admin - Ajouter un client +</title>
            </Head>
                                            ...
                                            <optgroup key={pack._id} label={pack.name}>
                                                {
                                                    prestations.map((prestation: Prestations) => (
                                                        <option key={prestation._id} value={prestation._id}>{prestation.name}</option>
                                                    ))
                                                }
                                            </optgroup>
                                        )
                                ...
                                <optgroup label="Formules individuelles">
                                    {
                                        packs.map((pack: Packs) => (
                                            formules.map((formule: Formules) => (
                                                <option key={formule._id} value={`Formule ${formule.name}`}>{formule.name}</option>
                                            ))
                                        ))
                                    }
                                </optgroup>
