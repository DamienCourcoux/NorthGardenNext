...
import { handleChangePrestation, handleSelectChangePrestation, handleCloseModalPrestation, handleAddPrestationSucces } from '../../../redux/reducer/reducerAdminPrestation';
import { addPrestation } from '../../../lib/requestApiPrestations';
...
export default function AddPrestationAdmin() {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (name === '') {
            ...
            const json = await addPrestation(formData);
            if (json) {
                dispatch(handleAddPrestationSucces());
                router.push('/admin/prestations');
                notify();
            }
        }
    ...
    return (
        <LayoutAdmin>
            <Head>
                <title>North Garden | Admin - Ajouter une prestation +</title>
            </Head>
            <div className="container" onClick={handleCloseModal}>
                ...
                <div className="containerForm">
                    <form className="containerFormForm addElement" onSubmit={handleSubmit}>
                        ...
                        <Field type="text" name="mowing" value={mowing} onChange={handleChange} />
                        <Field type="text" name="hedgeTrimmer" value={hedgeTrimmer} onChange={handleChange} />
                        <Field type="text" name="bushPruning" value={bushPruning} onChange={handleChange} />
                        <Field type="text" name="weeding" value={weeding} onChange={handleChange} />
                        <Field type="text" name="brushCutter" value={brushCutter} onChange={handleChange} />
                        <Field type="text" name="planting" value={planting} onChange={handleChange} />
                        <Field type="text" name="tarpaulin" value={tarpaulin} onChange={handleChange} />
                        <Field type="text" name="mulching" value={mulching} onChange={handleChange} />
                        <Field type="text" name="planters" value={planters} onChange={handleChange} />
                        <Field type="text" name="aromaticSeasonalFlower" value={aromaticSeasonalFlower} onChange={handleChange} />
                        <Field type="text" name="soil" value={soil} onChange={handleChange} />
                        <Field type="text" name="fertilizer" value={fertilizer} onChange={handleChange} />
                        <Field type="text" name="composition" value={composition} onChange={handleChange} />
                        <Field type="text" name="brushing" value={brushing} onChange={handleChange} />
                        <Field type="text" name="washing" value={washing} onChange={handleChange} />
                        <Field type="text" name="photo" value={photo} onChange={handleChange} />
                        <Field type="text" name="blower" value={blower} onChange={handleChange} />
                        <Field type="text" name="pickup" value={pickup} onChange={handleChange} />
                        <Field type="text" name="gifts" value={gifts} onChange={handleChange} />
