...
export const getPictures = async () => {
    const response = await fetch(`${BASE_URL}/api/pictures`);
...
export const getPicture = async (pictureId: string) => {
    const response = await fetch(`${BASE_URL}/api/pictures/${pictureId}`);
    const json = await response.json();
    if (json) return json;
    return {};
}
...
export async function addPicture(formData: Object) {
    try {
        ...
        const response = await fetch(`${BASE_URL}/api/pictures`, Options);
        const json = await response.json();
        return json;
    } catch (error) {
        return error;
...
export async function updatePicture(pictureId: string, formData: Object) {
    ...
    const response = await fetch(`${BASE_URL}/api/pictures/${pictureId}`, Options);
    const json = await response.json();
    return json;
}
